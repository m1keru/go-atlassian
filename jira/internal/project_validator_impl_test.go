...
func Test_internalProjectValidatorImpl_Validate(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			on: func(fields *fields) {
				...
				client.On("Call",
					&http.Request{},
					&model.ProjectValidationMessageScheme{}).
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			resolutionService, err := NewProjectValidatorService(testCase.fields.c, testCase.fields.version)
			assert.NoError(t, err)

			gotResult, gotResponse, err := resolutionService.Validate(testCase.args.ctx, testCase.args.key)
...
func Test_internalProjectValidatorImpl_Key(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResult, gotResponse, err := resolutionService.Key(testCase.args.ctx, testCase.args.key)
...
func Test_internalProjectValidatorImpl_Name(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResult, gotResponse, err := resolutionService.Name(testCase.args.ctx, testCase.args.name)
...
func Test_NewProjectValidatorService(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			got, err := NewProjectValidatorService(testCase.args.client, testCase.args.version)
