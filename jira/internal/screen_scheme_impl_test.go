...
func Test_internalScreenSchemeImpl_Create(t *testing.T) {

	payloadMocked := &model.ScreenSchemePayloadScheme{
...
func Test_internalScreenSchemeImpl_Update(t *testing.T) {
...
func Test_NewScreenSchemeService(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			got, err := NewScreenSchemeService(testCase.args.client, testCase.args.version)
