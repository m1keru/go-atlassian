...
func Test_internalProjectRoleImpl_Gets(t *testing.T) {
	...
	}{
		{
			...
			on: func(fields *fields) {
				...
				client.On("Call",
					&http.Request{},
					nil).
					Return(&model.ResponseScheme{Bytes: responseMocked}, nil)
...
func Test_internalProjectRoleImpl_Global(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResult, gotResponse, err := newService.Global(testCase.args.ctx)
...
func Test_internalProjectRoleImpl_Create(t *testing.T) {

	payloadMocked := &model.ProjectRolePayloadScheme{
		Name:        "Tempo Manager",
	...
	type args struct {
		ctx     context.Context
		payload *model.ProjectRolePayloadScheme
	}
...
func Test_NewProjectRoleService(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			got, err := NewProjectRoleService(testCase.args.client, testCase.args.version, nil)
