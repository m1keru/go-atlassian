...
func Test_internalProjectTypeImpl_Gets(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			resolutionService, err := NewProjectTypeService(testCase.fields.c, testCase.fields.version)
			assert.NoError(t, err)

			gotResult, gotResponse, err := resolutionService.Gets(testCase.args.ctx)
...
func Test_internalProjectTypeImpl_Licensed(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResult, gotResponse, err := resolutionService.Licensed(testCase.args.ctx)
...
func Test_internalProjectTypeImpl_Get(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResult, gotResponse, err := resolutionService.Get(testCase.args.ctx, testCase.args.projectTypeKey)
...
func Test_internalProjectTypeImpl_Accessible(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			gotResult, gotResponse, err := resolutionService.Accessible(testCase.args.ctx, testCase.args.projectTypeKey)
...
func Test_NewProjectTypeService(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			got, err := NewProjectTypeService(testCase.args.client, testCase.args.version)
